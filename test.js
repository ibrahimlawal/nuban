const nuban = require('./index');

const { validateAccountNumber } = nuban;

const shouldnotbevalid = validateAccountNumber('0123456789', '011');
const shouldbevalid = nuban.validate('0123456784', '011');
